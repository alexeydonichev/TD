...
const riftReinforcements = [
  ...
  { after: 17, kind: 'upgrade', x: 650, y: 220 },
  { after: 18, kind: 'build', type: 'archer', x: 1130, y: 390 },
  ...
  { after: 19, kind: 'upgrade', x: 1050, y: 200 },
  { after: 19, kind: 'build', type: 'archer', x: 980, y: 100 },
  { after: 19, kind: 'target', x: 980, y: 100 },
  { after: 19, kind: 'upgrade', x: 980, y: 100 },
  { after: 19, kind: 'upgrade', x: 980, y: 100 },
  { after: 19, kind: 'build', type: 'boost', x: 900, y: 100 },
  { after: 19, kind: 'build', type: 'archer', x: 850, y: 550 },
  { after: 19, kind: 'target', x: 850, y: 550 },
  { after: 19, kind: 'upgrade', x: 850, y: 550 },
